...
/**
 * agEventFacilityResourceStatusBulkLoad form base class.
 *
 * @method agEventFacilityResourceStatusBulkLoad getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagEventFacilityResourceStatusBulkLoadForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'agEventFacilityResourceStatusBulkLoad', 'column' => array('event_facility_resource_id', 'time_stamp')))
    );

    $this->widgetSchema->setNameFormat('ag_event_facility_resource_status_bulk_load[%s]');
