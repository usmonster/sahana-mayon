...
/**
 * agIso31661Alpha3 form base class.
 *
 * @method agIso31661Alpha3 getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagIso31661Alpha3Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'agIso31661Alpha3', 'column' => array('value')))
    );

    $this->widgetSchema->setNameFormat('ag_iso31661_alpha3[%s]');
