...
/**
 * agMaritalStatus form base class.
 *
 * @method agMaritalStatus getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagMaritalStatusForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'marital_status' => new sfValidatorString(array('max_length' => 32)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'agMaritalStatus', 'column' => array('marital_status')))
    );

    $this->widgetSchema->setNameFormat('ag_marital_status[%s]');
