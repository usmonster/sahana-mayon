...
/**
 * agIso31661Numeric form base class.
 *
 * @method agIso31661Numeric getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagIso31661NumericForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'value'           => new sfValidatorString(array('max_length' => 3)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'agIso31661Numeric', 'column' => array('value')))
    );

    $this->widgetSchema->setNameFormat('ag_iso31661_numeric[%s]');
