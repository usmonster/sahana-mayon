...
/**
 * agIso31662 form base class.
 *
 * @method agIso31662 getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagIso31662Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'value'           => new sfValidatorString(array('max_length' => 20)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'agIso31662', 'column' => array('value')))
    );

    $this->widgetSchema->setNameFormat('ag_iso31662[%s]');
