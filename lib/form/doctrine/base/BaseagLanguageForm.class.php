...
/**
 * agLanguage form base class.
 *
 * @method agLanguage getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagLanguageForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'language'       => new sfValidatorString(array('max_length' => 128)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'agLanguage', 'column' => array('language')))
    );

    $this->widgetSchema->setNameFormat('ag_language[%s]');
