...
/**
 * agReligion form base class.
 *
 * @method agReligion getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagReligionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'religion'       => new sfValidatorString(array('max_length' => 128)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'agReligion', 'column' => array('religion')))
    );

    $this->widgetSchema->setNameFormat('ag_religion[%s]');
