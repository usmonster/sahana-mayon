...
/**
 * agImportType form base class.
 *
 * @method agImportType getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagImportTypeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'             => new sfWidgetFormInputHidden(),
      'import_type'    => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'import_type'    => new sfValidatorString(array('max_length' => 128)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'agImportType', 'column' => array('import_type')))
    );

    $this->widgetSchema->setNameFormat('ag_import_type[%s]');
