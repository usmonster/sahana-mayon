...
/**
 * agProfession form base class.
 *
 * @method agProfession getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagProfessionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'profession'     => new sfValidatorString(array('max_length' => 128)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'agProfession', 'column' => array('profession')))
    );

    $this->widgetSchema->setNameFormat('ag_profession[%s]');
