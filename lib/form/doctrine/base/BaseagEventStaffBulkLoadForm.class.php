...
/**
 * agEventStaffBulkLoad form base class.
 *
 * @method agEventStaffBulkLoad getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagEventStaffBulkLoadForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'agEventStaffBulkLoad', 'column' => array('event_id', 'staff_resource_id')))
    );

    $this->widgetSchema->setNameFormat('ag_event_staff_bulk_load[%s]');
