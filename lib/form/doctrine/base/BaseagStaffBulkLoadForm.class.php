...
/**
 * agStaffBulkLoad form base class.
 *
 * @method agStaffBulkLoad getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagStaffBulkLoadForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'agStaffBulkLoad', 'column' => array('person_id')))
    );

    $this->widgetSchema->setNameFormat('ag_staff_bulk_load[%s]');
