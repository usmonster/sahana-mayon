...
/**
 * agEventRelativeShift form base class.
 *
 * @method agEventRelativeShift getObject() Returns the current form's model object
 *
 * @package    AGASTI_CORE
 * @subpackage form
 * @author     CUNY SPS
 ...
 */
abstract class BaseagEventRelativeShiftForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ag_event_relative_shift[%s]');
