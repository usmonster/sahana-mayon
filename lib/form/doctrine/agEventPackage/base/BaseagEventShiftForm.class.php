...
abstract class BaseagEventShiftForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'break_start'                          => new sfWidgetFormDateTime(),
      'break_end'                            => new sfWidgetFormDateTime(),
    ...
    $this->setValidators(array(
      ...
      'break_start'                          => new sfValidatorDateTime(array('required' => false)),
      'break_end'                            => new sfValidatorDateTime(array('required' => false)),
