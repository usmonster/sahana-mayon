...
/**
 * agStaffStatus filter form base class.
 *
 * @package    AGASTI_CORE
 * @subpackage filter
 * @author     CUNY SPS
 ...
 */
abstract class BaseagStaffStatusFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'staff_status'   => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'staff_status'   => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ag_staff_status_filters[%s]');
  ...
  public function addAgPersonListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('agStaff.person_id', $values)
    ;
  }
