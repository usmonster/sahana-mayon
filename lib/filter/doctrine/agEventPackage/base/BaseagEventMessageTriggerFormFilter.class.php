...
/**
 * agEventMessageTrigger filter form base class.
 *
 * @package    AGASTI_CORE
 * @subpackage filter
 * @author     CUNY SPS
 ...
 */
abstract class BaseagEventMessageTriggerFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ag_event_message_trigger_filters[%s]');
