...
abstract class BaseagFacilityResourceAllocationStatusFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'scenario_display'                    => new sfWidgetFormChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'))),
    ...
    $this->setValidators(array(
      ...
      'scenario_display'                    => new sfValidatorChoice(array('required' => false, 'choices' => array('', 1, 0))),
