 ...
 */
abstract class BaseagSexFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ag_sex_filters[%s]');
  ...
  public function addAgPersonListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('agPersonSex.person_id', $values)
    ;
  }
