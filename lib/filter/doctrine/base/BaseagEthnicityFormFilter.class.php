...
/**
 * agEthnicity filter form base class.
 *
 * @package    AGASTI_CORE
 * @subpackage filter
 * @author     CUNY SPS
 ...
 */
abstract class BaseagEthnicityFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ag_ethnicity_filters[%s]');
  ...
  public function addAgPersonListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('agPersonEthnicity.person_id', $values)
    ;
  }
