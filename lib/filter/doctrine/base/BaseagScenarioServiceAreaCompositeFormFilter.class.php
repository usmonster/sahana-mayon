...
/**
 * agScenarioServiceAreaComposite filter form base class.
 *
 * @package    AGASTI_CORE
 * @subpackage filter
 * @author     CUNY SPS
 ...
 */
abstract class BaseagScenarioServiceAreaCompositeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ag_scenario_service_area_composite_filters[%s]');
