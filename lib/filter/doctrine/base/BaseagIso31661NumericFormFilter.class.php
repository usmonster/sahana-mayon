...
/**
 * agIso31661Numeric filter form base class.
 *
 * @package    AGASTI_CORE
 * @subpackage filter
 * @author     CUNY SPS
 ...
 */
abstract class BaseagIso31661NumericFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ag_iso31661_numeric_filters[%s]');
  ...
  public function addAgCountryListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('agCountryMjAgIso31661Numeric.country_id', $values)
    ;
  }
