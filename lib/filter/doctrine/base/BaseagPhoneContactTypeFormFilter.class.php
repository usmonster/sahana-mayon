...
/**
 * agPhoneContactType filter form base class.
 *
 * @package    AGASTI_CORE
 * @subpackage filter
 * @author     CUNY SPS
 ...
 */
abstract class BaseagPhoneContactTypeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'phone_contact_type'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'phone_contact_type'    => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('ag_phone_contact_type_filters[%s]');
