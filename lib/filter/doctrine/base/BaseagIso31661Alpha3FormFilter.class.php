...
/**
 * agIso31661Alpha3 filter form base class.
 *
 * @package    AGASTI_CORE
 * @subpackage filter
 * @author     CUNY SPS
 ...
 */
abstract class BaseagIso31661Alpha3FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ag_iso31661_alpha3_filters[%s]');
  ...
  public function addAgCountryListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ...
      ->andWhereIn('agCountryMjAgIso31661Alpha3.country_id', $values)
    ;
  }
