...
/**
 * agPersonSkill filter form base class.
 *
 * @package    AGASTI_CORE
 * @subpackage filter
 * @author     CUNY SPS
 ...
 */
abstract class BaseagPersonSkillFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'date_expires'  => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
    ...
    $this->widgetSchema->setNameFormat('ag_person_skill_filters[%s]');
