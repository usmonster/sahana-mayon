...
/**
 * agDefaultScenarioFacilityResourceType filter form base class.
 *
 * @package    AGASTI_CORE
 * @subpackage filter
 * @author     CUNY SPS
 ...
 */
abstract class BaseagDefaultScenarioFacilityResourceTypeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ag_default_scenario_facility_resource_type_filters[%s]');
