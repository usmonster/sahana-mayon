...
<?php
  ...
  $columns = array(
    ...
    'Delete Group Shifts' => array('title' => 'shift count', 'sortable' => false)
  );
...
<table class="staffTable">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo link_to('Delete Shifts', 'scenario/deletescenarioshiftgroup?scenId='.$scenarioShiftGroup->getId(), array('method' => 'delete', 'confirm' => 'Are you sure?', 'class' => 'linkButton')) ?></td>
    </tr>
    <?php endforeach; ?>
  </tbody>
</table>
