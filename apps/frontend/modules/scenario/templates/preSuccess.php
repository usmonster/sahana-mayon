...
<p>Resources, such as staff and facilities, should be loaded into the <?php echo sfConfig::get('sf_application_name'); ?> to plan with.
  Staff and facilities have different rules for inclusion, and though scenarios could be built
