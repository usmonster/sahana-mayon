...
<a href="<?php echo url_for('scenario/resourcetypes?id=' . $scenario_id) ?>"
   title="Edit Required Resource Types for Scenario" class="linkButton">Manage Required Resource Types</a> <br /><br />
