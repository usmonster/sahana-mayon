...
?>
  ...
  <table cellspacing='20'>
    <tr>
      <td><?php echo link_to('Prepare', 'home/prepare', array('class' => 'continueButton width140', 'title' => 'Prepare a Response Scenario')); ?></td>
      <td><?php echo link_to('Respond', 'home/respond', array('class' => 'continueButton width140', 'title' => 'Deploy and Manage Events')); ?></td>
    </tr>
    <tr>
      <td><?php echo link_to('Wiki Home', public_path('wiki/doku.php'), array('class' => 'continueButton width140', 'title' => 'Help', 'target' => '_blank')); ?></td>
      <td><?php echo link_to('Administration', 'admin/index', array('class' => 'continueButton width140', 'title' => 'Administration')); ?></td>
    </tr>
  </table>
<?php
}
