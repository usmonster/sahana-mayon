...
<?php if (!empty($vesuvius_address) && $vesuvius_address != "http://") : ?>    
    <h3>If you are working at a shelter with and entering client data:</h3>
    <table cellspacing='20'>
        <tr>
            <td>
                <a href="<?php echo $vesuvius_address; ?>" class="generalButton width140" title="Jump to the Sahana Registry Program" target="_blank"> Jump to the Sahana Registry Program</a>
            </td>
        </tr>
    </table>
<?php endif; ?>