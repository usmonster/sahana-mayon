...
<table cellspacing="20">
    <tr>
      ...
      <td><?php echo link_to('Deploy a<br>Scenario', 'scenario/index', array('class' => 'linkButton width140')) ?></td>
    </tr>
    <tr>
      ...
      <td><?php echo link_to('Manage<br>Existing Scenarios', 'scenario/list', array('class' => 'linkButton width140')) ?></td>
      <td></td>
    </tr>
</table>
