...
class agFormFormatterInlineLeftLabel extends sfWidgetFormSchemaFormatter
{
  ...
  $errorRowFormat = "<span>\n%errors%<span>\n",
  $helpFormat = '<br />%help%',
  $decoratorFormat = "<div class=\"table-container\" style=\"width:600px; overflow:wrap; padding:15px 1px 5pxpx 12px\">%content%</div><hr style=\"color: #ff6600; background-color: #ff6600; height:1px; width:70%;\"/>";
}