...
class agEmbeddedAgFacilityStaffResourceForm extends agFacilityStaffResourceForm
{
  ...
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'minimum_staff' => new sfWidgetFormInputText(array('label' => 'Min'),
          array('class' => 'inputGraySmall')),
      'maximum_staff' => new sfWidgetFormInputText(array('label' => 'Max'),
          array('class' => 'inputGraySmall')),
    ...
    $this->setValidators(array(
      ...
      'scenario_facility_resource_id' => new sfValidatorDoctrineChoice(array('model' =>
        $this->getRelatedModelName('agScenarioFacilityResource'))),
      'staff_resource_type_id' => new sfValidatorDoctrineChoice(array('model' =>
        $this->getRelatedModelName('agStaffResourceType'))),
