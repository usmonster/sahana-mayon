...
//  private static $staticLists;
  ...
  public function setup()
  {
    ...
    $this->setWidgets(array(
      ...
      'task_length_minutes' => new sfWidgetFormInputText(array(), array('class' => 'inputGray')),
      'break_length_minutes' => new sfWidgetFormInputText(array(), array('class' => 'inputGray')),
      'minutes_start_to_facility_activation' => new sfWidgetFormInputText(array(), array('class' => 'inputGray')),
      'shift_repeats' => new sfWidgetFormInputText(array(), array('class' => 'inputGray')),
      'max_staff_repeat_shifts' => new sfWidgetFormInputText(array(), array('class' => 'inputGray')),
