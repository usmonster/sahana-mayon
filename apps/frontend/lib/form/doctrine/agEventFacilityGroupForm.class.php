  ...
  **/
  public function setup()
  {
    ...
    $this->setWidgets(array(
      ...
      'ag_facility_resource_list'           => new sfWidgetFormInputHidden(),//sfWidgetFormDoctrineChoice(array('multiple' => true, 'model' => 'agFacilityResource', 'expanded' => false), array('class' => 'widthAndHeight150')), //this will be hidden
      'ag_facility_resource_order'          => new sfWidgetFormInputHidden(),//sfWidgetFormChoice(array('choices' => $currentoptions,'multiple' => true),array('class' => 'widthAndHeight150')) //this will be hidden
      ));
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorAnd(array(
        new sfValidatorDoctrineUnique(array('model' => 'agEventFacilityGroup', 'column' => array('id'))),
 ...
 */
   ...
   * relevant to event facility groups, facility resources and their activation sequence
   */
    ...
    if($alloc_array)
    {
      ...
      foreach($alloc_array as $key => $value)
      {
        if( in_array($value,$current)){
          ...
          ->findByDql('facility_resource_id = ? AND event_facility_group_id = ?', array($value,$this->getObject()->getId()))->getFirst();
