  ...
  public function setup()
  {
    ...
    foreach ($current as $curopt) {
      $currentoptions[$curopt->facility_resource_id] =
          ...
          $curopt->getAgFacilityResource()->getAgFacilityResourceType()->facility_resource_type;
      //$curopt->getAgFacility()->facility_name . " : " .
      //$curopt->getAgFacilityResourceType()->facility_resource_type;
      /**
    ...
    $this->setWidgets(array(
      ...
      'facility_group_type_id' => new sfWidgetFormDoctrineChoice(array('model' =>
        $this->getRelatedModelName('agFacilityGroupType'), 'add_empty' => false)),
      'facility_group_allocation_status_id' => new sfWidgetFormDoctrineChoice(array('model' =>
        $this->getRelatedModelName('agFacilityGroupAllocationStatus'), 'add_empty' => false,
      ...
      //'ag_facility_resource_list'          => new sfWidgetFormChoice(array('choices' =>
      //$availtoptions,'multiple' => true),array('class' => 'widthAndHeight150')),
      'ag_facility_resource_list' => new sfWidgetFormDoctrineChoice(array('multiple' => true,
    ...
    $this->setValidators(array(
      ...
      'scenario_id' => new sfValidatorDoctrineChoice(array('model' =>
        $this->getRelatedModelName('agScenario'))),
      'scenario_facility_group' => new sfValidatorString(array('max_length' => 64)),
      'facility_group_type_id' => new sfValidatorDoctrineChoice(array('model' =>
        $this->getRelatedModelName('agFacilityGroupType'))),
      'facility_group_allocation_status_id' => new sfValidatorDoctrineChoice(array('model' =>
        $this->getRelatedModelName('agFacilityGroupAllocationStatus'))),
    ...
    $this->validatorSchema->setPostValidator(
        new sfValidatorAnd(array(
          new sfValidatorDoctrineUnique(array('model' => 'agScenarioFacilityGroup', 'column' =>
            array('id'))),
          new sfValidatorDoctrineUnique(array('model' => 'agScenarioFacilityGroup', 'column' =>
            array('scenario_id', 'scenario_facility_group'))),
          new sfValidatorDoctrineUnique(array('model' => 'agScenarioFacilityGroup', 'column' =>
            array('scenario_facility_group'))),
        ))
    );
