  ...
  public function setup()
  {
    ...
    $this->setWidgets(
        array(
          ...
          'ag_facility_resource_list' => new sfWidgetFormDoctrineChoice(
              array(
                'multiple' => true,
                'model' => 'agFacilityResource', 'expanded' => false),
              array(
                'class' => 'widthAndHeight300')
          ),
          'ag_facility_resource_order' => new sfWidgetFormChoice(
              array(
    ...
    $this->setValidators(
        array(
          ...
          'ag_facility_resource_list' => new sfValidatorDoctrineChoice(
              array(
                'multiple' => true,
    ...
    $this->validatorSchema->setPostValidator(
        new sfValidatorAnd(
            array(
              ...
              new sfValidatorDoctrineUnique(
                  array('model' => 'agScenarioFacilityGroup', 'column' => array(
                      'scenario_id',
