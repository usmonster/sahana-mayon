...
class AgStaffImportXLS extends AgImportXLS
{
  ...
  function __construct()
  {
    ...
    'entity_id' => array('type' => 'integer', 'autoincrement' => true, 'primary' => true),
    ...
    'home_street_1' => array('type' => "string", 'length' => 255),
    'home_street_2' => array('type' => "string", 'length' => 255),
    'home_city' => array('type' => "string", 'length' => 255),
    'home_state' => array('type' => "string", 'length' => 255),
    'home_zip' => array('type' => "string", 'length' => 5),
    //'borough' => array('type' => "string", 'length' => 30),
    'home_country' => array('type' => "string", 'length' => 64),
    'home_latitude' => array('type' => "decimal", 'length' => 12, 'scale' => 8),
    'home_longitude' => array('type' => "decimal", 'length' => 12, 'scale' => 8),
    'work_street_1' => array('type' => "string", 'length' => 255),
    'work_street_2' => array('type' => "string", 'length' => 255),
    'work_city' => array('type' => "string", 'length' => 255),
    'work_state' => array('type' => "string", 'length' => 255),
    'work_zip' => array('type' => "string", 'length' => 5),
    //'borough' => array('type' => "string", 'length' => 30),
    'work_country' => array('type' => "string", 'length' => 64),
