...
abstract class agEntityContactHelper extends agBulkRecordHelper
{
   ...
   */
  protected function reprioritizeContacts(array $entityContacts, array $currContacts)
  {
   ...
   */
  public function setEntityContactById(array $entityContacts,
                                       $keepHistory = NULL,
                                       $throwOnError = NULL,
                                       Doctrine_Connection $conn = NULL)
  {
    ...
    $useSavepoint = ($conn->getTransactionLevel() > 0);
    if ($useSavepoint) {
