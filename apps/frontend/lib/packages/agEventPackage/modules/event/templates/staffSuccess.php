...
<a href="<?php echo url_for('event/staffin'); ?>" class="continueButton" title="Generate All Staff Contact List as Export">Generate All Staff Contact List</a><br />


<p>After staff have replied to the external messaging system please import their replies.</p>
<a href="<?php echo url_for('event/staffin'); ?>" class="continueButton" title="Import Staff Replies">Import Staff Replies</a><br />
