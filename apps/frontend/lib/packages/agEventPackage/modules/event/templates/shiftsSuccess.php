...
<table class="staffTable">
  ...
  <tbody>
    ...
    <tr>
      <td><a class=linkButton href="<?php echo url_for('event/shifts?id='.$ag_event_shift->getId()) ?>" title="View event Shift <?php echo $ag_event_shift->getId() ?>"><?php echo $recordRowNumber++; ?></a></td>
