...
<td><a href="<?php echo url_for('event/staffshift?event=' . urlencode($sf_data->getRaw('event_name'))) . $append ?>" class="continueButton modalTrigger" title="Add Staff to Shift">add staff</a></td>
          <table>
            <tfoot>
              <tr>
                <td colspan="2">
