...
class agGisQuery {
   ...
   */
  public static function searchUnrelatedGeo($returnCount, $leftRelation, $rightRelation) {
    return self::findUnrelatedGeoMySQL($returnCount, $leftRelation, $rightRelation);
  }
