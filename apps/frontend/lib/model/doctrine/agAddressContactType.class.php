...
*
* @return the string value of the address_contact_type field
 * from the ag_address_contact_type table. __toString is used to get that value instead of the ID.
