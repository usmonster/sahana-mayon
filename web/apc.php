...
$VERSION='$Id: apc.php 301867 2010-08-05 09:10:58Z pajoye $';
...
defaults('USE_AUTHENTICATION',1);			// Use (internal) authentication - best choice if 
											...
											//  this work!
defaults('ADMIN_USERNAME','agasti'); 			// Admin Username
defaults('ADMIN_PASSWORD','agasti');  	// Admin Password - CHANGE THIS TO ENABLE!!!
