...
if (file_exists(DOKU_PLUGIN."bookcreator/action.php") &&
    ...
    $_vector_tabs_left["tab-bookcreator"]["text"] = "Add/Remove page to book";
    $_vector_tabs_left["tab-bookcreator"]["href"] = wl(getID(), array("do" => "addtobook"), false, "&");
    $_vector_tabs_left["tab-bookcreator"]["nofollow"] = true;
}
